import "./chunk-6RDZZU5T.js";
import {
  Portal
} from "./chunk-XRQAK4DK.js";
import {
  Typography_default
} from "./chunk-SRXYK7SQ.js";
import {
  require_react_dom
...
import {
  useTheme
} from "./chunk-6XQHF7PE.js";
import {
  useClassNamesOverride,
  useSlotProps
} from "./chunk-7JHEQ3F2.js";
import {
  Box_default
} from "./chunk-SU6UA6SI.js";
import "./chunk-FWE7LVOB.js";
import {
  styled_default
} from "./chunk-D2WNXVHW.js";
import {
  HTMLElementType,
  chainPropTypes,
  exactProp,
...
function useDrawingArea() {
  ...
  return React6.useMemo(() => ({
    ...
    bottom: bottom2,
    right: right2
  }), [height, left2, top2, width, bottom2, right2]);
}
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime18.jsx)(React18.Fragment, {
...
true ? DefaultChartsItemTooltipContent.propTypes = {
  ...
  series: import_prop_types11.default.shape({
    ...
    data: import_prop_types11.default.oneOfType([import_prop_types11.default.arrayOf(import_prop_types11.default.number), import_prop_types11.default.arrayOf(import_prop_types11.default.number), import_prop_types11.default.arrayOf(import_prop_types11.default.shape({
    ...
    })), import_prop_types11.default.arrayOf(import_prop_types11.default.shape({
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React22.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types12.default.shape({
    ...
    series: import_prop_types12.default.shape({
      color: import_prop_types12.default.string,
      data: import_prop_types12.default.oneOfType([import_prop_types12.default.arrayOf(import_prop_types12.default.number), import_prop_types12.default.arrayOf(import_prop_types12.default.number), import_prop_types12.default.arrayOf(import_prop_types12.default.shape({
        ...
        x: import_prop_types12.default.number.isRequired,
        y: import_prop_types12.default.number.isRequired
      })), import_prop_types12.default.arrayOf(import_prop_types12.default.shape({
      ...
      highlightScope: import_prop_types12.default.shape({
        faded: import_prop_types12.default.oneOf(["global", "none", "series"]),
        highlighted: import_prop_types12.default.oneOf(["item", "none", "series"])
      }),
      id: import_prop_types12.default.oneOfType([import_prop_types12.default.number, import_prop_types12.default.string]).isRequired,
      type: import_prop_types12.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired,
      valueFormatter: import_prop_types12.default.func.isRequired
    }),
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axisValue: import_prop_types13.default.any.isRequired,
  /**
   * Override or extend the styles applied to the component.
   */
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types14.default.shape({
    axis: import_prop_types14.default.object,
    axisData: import_prop_types14.default.shape({
      x: import_prop_types14.default.shape({
        index: import_prop_types14.default.number,
        value: import_prop_types14.default.oneOfType([import_prop_types14.default.instanceOf(Date), import_prop_types14.default.number, import_prop_types14.default.string]).isRequired
    ...
    axisValue: import_prop_types14.default.any,
    classes: import_prop_types14.default.object,
    dataIndex: import_prop_types14.default.number,
    series: import_prop_types14.default.arrayOf(import_prop_types14.default.object),
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime28.jsxs)(React26.Fragment, {
...
var HighlighContext = React30.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React30.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
  const value = React30.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var useInteractionItemProps = (scope) => {
  ...
  } = React31.useContext(HighlighContext);
...
var _excluded6 = ["id", "dataIndex", "classes", "color", "highlightScope", "slots", "slotProps", "style"];
...
var useCompletedData = () => {
  ...
  const seriesData = (_React$useContext$bar = React33.useContext(SeriesContext).bar) != null ? _React$useContext$bar : {
    series: {},
    stackingGroups: [],
    seriesOrder: []
  };
  const axisData = React33.useContext(CartesianContext);
  const {
    series,
    stackingGroups
  } = seriesData;
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const {
    ...
    xAxisIds,
    yAxisIds
  } = React34.useContext(CartesianContext);
  const {
    dispatch
  ...
  React34.useEffect(() => {
    ...
    const handleMouseMove = (event) => {
      ...
      const outsideX = svgPt.x < left2 || svgPt.x > left2 + width;
      const outsideY = svgPt.y < top2 || svgPt.y > top2 + height;
...
var _excluded8 = ["children", "width", "height", "viewBox", "disableAxisListener", "className"];
var ChartChartsSurfaceStyles = styled_default("svg", {
  name: "MuiChartsSurface",
  slot: "Root"
})(() => ({}));
var ChartsSurface = React35.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
...
var ResponsiveChartContainer = React37.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
...
function DefaultChartsLegend(props) {
  ...
  const seriesWithPosition = React38.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
...
function ChartsLegend(inProps) {
  ...
  const drawingArea = React38.useContext(DrawingContext);
...
var BarChart = React39.forwardRef(function BarChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
...
true ? BarChart.propTypes = {
   ...
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types21.default.oneOfType([import_prop_types21.default.shape({
  ...
  layout: import_prop_types21.default.oneOf(["horizontal", "vertical"]),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types21.default.oneOfType([import_prop_types21.default.shape({
    axisId: import_prop_types21.default.oneOfType([import_prop_types21.default.number, import_prop_types21.default.string]),
    classes: import_prop_types21.default.object,
    disableLine: import_prop_types21.default.bool,
    disableTicks: import_prop_types21.default.bool,
   ...
   * @default null
   */
  rightAxis: import_prop_types21.default.oneOfType([import_prop_types21.default.shape({
    axisId: import_prop_types21.default.oneOfType([import_prop_types21.default.number, import_prop_types21.default.string]),
    classes: import_prop_types21.default.object,
    disableLine: import_prop_types21.default.bool,
    disableTicks: import_prop_types21.default.bool,
  ...
  series: import_prop_types21.default.arrayOf(import_prop_types21.default.shape({
    color: import_prop_types21.default.string,
    data: import_prop_types21.default.arrayOf(import_prop_types21.default.number),
    ...
    label: import_prop_types21.default.string,
    layout: import_prop_types21.default.oneOf(["horizontal", "vertical"]),
    stack: import_prop_types21.default.string,
    stackOffset: import_prop_types21.default.oneOf(["diverging", "expand", "none", "silhouette", "wiggle"]),
    stackOrder: import_prop_types21.default.oneOf(["appearance", "ascending", "descending", "insideOut", "none", "reverse"]),
    type: import_prop_types21.default.oneOf(["bar"]),
    valueFormatter: import_prop_types21.default.func,
    xAxisKey: import_prop_types21.default.string,
    yAxisKey: import_prop_types21.default.string
  })).isRequired,
  /**
   * If `true`, animations are skiped.
   * @default false
   ...
   * @default null
   */
  topAxis: import_prop_types21.default.oneOfType([import_prop_types21.default.shape({
    axisId: import_prop_types21.default.oneOfType([import_prop_types21.default.number, import_prop_types21.default.string]),
    classes: import_prop_types21.default.object,
    disableLine: import_prop_types21.default.bool,
    disableTicks: import_prop_types21.default.bool,
...
var _excluded11 = ["id", "classes", "color", "highlightScope", "slots", "slotProps"];
...
var _excluded13 = ["id", "classes", "color", "highlightScope", "slots", "slotProps"];
...
var _excluded15 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "highlightScope"];
...
MarkElementPath.propTypes = {
  ...
  ownerState: import_prop_types26.default.shape({
    ...
    x: import_prop_types26.default.number.isRequired,
    y: import_prop_types26.default.number.isRequired
  }).isRequired,
...
true ? MarkElement.propTypes = {
   ...
   */
  shape: import_prop_types26.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]).isRequired
} : void 0;
...
function LineHighlightPlot(props) {
  ...
  const seriesData = React47.useContext(SeriesContext).line;
  const axisData = React47.useContext(CartesianContext);
  const {
    axis
  ...
  const defaultXAxisId = xAxisIds[0];
  const defaultYAxisId = yAxisIds[0];
  const Element2 = (_slots$lineHighlight = slots == null ? void 0 : slots.lineHighlight) != null ? _slots$lineHighlight : LineHighlightElement;
  return (0, import_jsx_runtime47.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        return (0, import_jsx_runtime47.jsx)(Element2, _extends({
          id: seriesId,
          color: series[seriesId].color,
          x: x2,
          y: y2
...
var LineChart = React48.forwardRef(function LineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
...
true ? LineChart.propTypes = {
   ...
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types30.default.oneOfType([import_prop_types30.default.shape({
    axisId: import_prop_types30.default.oneOfType([import_prop_types30.default.number, import_prop_types30.default.string]),
   ...
   */
  disableLineItemHighlight: import_prop_types30.default.bool,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   * @default undefined
   */
   ...
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types30.default.oneOfType([import_prop_types30.default.shape({
    axisId: import_prop_types30.default.oneOfType([import_prop_types30.default.number, import_prop_types30.default.string]),
    classes: import_prop_types30.default.object,
    disableLine: import_prop_types30.default.bool,
    disableTicks: import_prop_types30.default.bool,
   ...
   * @default null
   */
  rightAxis: import_prop_types30.default.oneOfType([import_prop_types30.default.shape({
    axisId: import_prop_types30.default.oneOfType([import_prop_types30.default.number, import_prop_types30.default.string]),
    classes: import_prop_types30.default.object,
    disableLine: import_prop_types30.default.bool,
    disableTicks: import_prop_types30.default.bool,
  ...
  series: import_prop_types30.default.arrayOf(import_prop_types30.default.shape({
    area: import_prop_types30.default.bool,
    color: import_prop_types30.default.string,
    connectNulls: import_prop_types30.default.bool,
    curve: import_prop_types30.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
    data: import_prop_types30.default.arrayOf(import_prop_types30.default.number),
    dataKey: import_prop_types30.default.string,
    disableHighlight: import_prop_types30.default.bool,
    ...
    label: import_prop_types30.default.string,
    showMark: import_prop_types30.default.oneOfType([import_prop_types30.default.func, import_prop_types30.default.bool]),
    stack: import_prop_types30.default.string,
    stackOffset: import_prop_types30.default.oneOf(["diverging", "expand", "none", "silhouette", "wiggle"]),
    stackOrder: import_prop_types30.default.oneOf(["appearance", "ascending", "descending", "insideOut", "none", "reverse"]),
    type: import_prop_types30.default.oneOf(["line"]),
    valueFormatter: import_prop_types30.default.func,
    xAxisKey: import_prop_types30.default.string,
    yAxisKey: import_prop_types30.default.string
  })).isRequired,
  /**
   * The props used for each component slot.
   * @default {}
   ...
   * @default null
   */
  topAxis: import_prop_types30.default.oneOfType([import_prop_types30.default.shape({
    axisId: import_prop_types30.default.oneOfType([import_prop_types30.default.number, import_prop_types30.default.string]),
    classes: import_prop_types30.default.object,
    disableLine: import_prop_types30.default.bool,
    disableTicks: import_prop_types30.default.bool,
  ...
  xAxis: import_prop_types30.default.arrayOf(import_prop_types30.default.shape({
    ...
    position: import_prop_types30.default.oneOf(["bottom", "left", "right", "top"]),
...
var _excluded19 = ["id", "dataIndex", "classes", "color", "highlightScope", "onClick", "isFaded", "isHighlighted", "startAngle", "endAngle", "paddingAngle", "innerRadius", "outerRadius", "cornerRadius"];
...
function useTransformData(series) {
  ...
  const getHighlightStatus = React50.useCallback((dataIndex) => {
  ...
  const dataWithHighlight = React50.useMemo(() => data.map((item, itemIndex) => {
...
var _excluded20 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "onClick", "skipAnimation"];
...
var _excluded21 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "arcLabelRadius", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "style"];
...
true ? PieArcLabel.propTypes = {
  ...
  formattedArcLabel: import_prop_types33.default.string,
  ...
  isFaded: import_prop_types33.default.bool.isRequired,
  isHighlighted: import_prop_types33.default.bool.isRequired
} : void 0;

// node_modules/@mui/x-charts/esm/PieChart/PieArcLabelPlot.js
var import_jsx_runtime53 = __toESM(require_jsx_runtime());
var _excluded25 = ["slots", "slotProps", "innerRadius", "outerRadius", "arcLabelRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "arcLabel", "arcLabelMinAngle", "skipAnimation"];
var _excluded26 = ["startAngle", "endAngle", "paddingAngle", "innerRadius", "outerRadius", "arcLabelRadius", "cornerRadius"];
  ...
  return (0, import_jsx_runtime53.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      let {
        ...
        arcLabelRadius: aLR,
        cornerRadius: cR
      } = _ref, style = _objectWithoutPropertiesLoose(_ref, _excluded26);
...
true ? PieArcLabelPlot.propTypes = {
  ...
  data: import_prop_types34.default.arrayOf(import_prop_types34.default.shape({
    ...
    endAngle: import_prop_types34.default.number.isRequired,
    formattedValue: import_prop_types34.default.string.isRequired,
    ...
    padAngle: import_prop_types34.default.number.isRequired,
    startAngle: import_prop_types34.default.number.isRequired,
   ...
   * The radius between circle center and the end of the arc.
   */
  outerRadius: import_prop_types34.default.number.isRequired,
  /**
   * The padding angle (deg) between two arcs.
   * @default 0
   */
...
function PiePlot(props) {
  ...
  const seriesData = React54.useContext(SeriesContext).pie;
  const {
    left: left2,
    top: top2,
    width,
...
true ? PieChart.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  axisHighlight: import_prop_types36.default.shape({
    x: import_prop_types36.default.oneOf(["band", "line", "none"]),
    y: import_prop_types36.default.oneOf(["band", "line", "none"])
  }),
  /**
   * Indicate which axis to display the bottom of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  bottomAxis: import_prop_types36.default.oneOfType([import_prop_types36.default.shape({
   ...
   * @default blueberryTwilightPalette
   */
  colors: import_prop_types36.default.oneOfType([import_prop_types36.default.arrayOf(import_prop_types36.default.string), import_prop_types36.default.func]),
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
  dataset: import_prop_types36.default.arrayOf(import_prop_types36.default.object),
  desc: import_prop_types36.default.string,
  /**
   * If `true`, the charts will not listen to the mouse move event.
   * It might break interactive features, but will improve performance.
   * @default false
   */
  disableAxisListener: import_prop_types36.default.bool,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   * @default undefined
   */
  height: import_prop_types36.default.number,
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  leftAxis: import_prop_types36.default.oneOfType([import_prop_types36.default.shape({
    axisId: import_prop_types36.default.oneOfType([import_prop_types36.default.number, import_prop_types36.default.string]),
    classes: import_prop_types36.default.object,
    disableLine: import_prop_types36.default.bool,
    disableTicks: import_prop_types36.default.bool,
    ...
    labelFontSize: import_prop_types36.default.number,
    labelStyle: import_prop_types36.default.object,
    position: import_prop_types36.default.oneOf(["left", "right"]),
    slotProps: import_prop_types36.default.object,
    slots: import_prop_types36.default.object,
    stroke: import_prop_types36.default.string,
    tickFontSize: import_prop_types36.default.number,
   ...
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types36.default.shape({
    classes: import_prop_types36.default.object,
   ...
   * @default object Depends on the charts type.
   */
  margin: import_prop_types36.default.shape({
   ...
   * @default null
   */
  rightAxis: import_prop_types36.default.oneOfType([import_prop_types36.default.shape({
    axisId: import_prop_types36.default.oneOfType([import_prop_types36.default.number, import_prop_types36.default.string]),
    classes: import_prop_types36.default.object,
    disableLine: import_prop_types36.default.bool,
    disableTicks: import_prop_types36.default.bool,
  ...
  series: import_prop_types36.default.arrayOf(import_prop_types36.default.shape({
    arcLabel: import_prop_types36.default.oneOfType([import_prop_types36.default.oneOf(["formattedValue", "label", "value"]), import_prop_types36.default.func]),
    arcLabelMinAngle: import_prop_types36.default.number,
    arcLabelRadius: import_prop_types36.default.oneOfType([import_prop_types36.default.number, import_prop_types36.default.string]),
    color: import_prop_types36.default.string,
    cornerRadius: import_prop_types36.default.number,
    cx: import_prop_types36.default.oneOfType([import_prop_types36.default.number, import_prop_types36.default.string]),
    cy: import_prop_types36.default.oneOfType([import_prop_types36.default.number, import_prop_types36.default.string]),
    data: import_prop_types36.default.arrayOf(import_prop_types36.default.shape({
      color: import_prop_types36.default.string,
      id: import_prop_types36.default.oneOfType([import_prop_types36.default.number, import_prop_types36.default.string]),
      label: import_prop_types36.default.string,
      value: import_prop_types36.default.number.isRequired
    })).isRequired,
    endAngle: import_prop_types36.default.number,
    ...
    id: import_prop_types36.default.oneOfType([import_prop_types36.default.number, import_prop_types36.default.string]),
    innerRadius: import_prop_types36.default.oneOfType([import_prop_types36.default.number, import_prop_types36.default.string]),
    outerRadius: import_prop_types36.default.oneOfType([import_prop_types36.default.number, import_prop_types36.default.string]),
    paddingAngle: import_prop_types36.default.number,
    sortingValues: import_prop_types36.default.oneOfType([import_prop_types36.default.oneOf(["asc", "desc", "none"]), import_prop_types36.default.func]),
    startAngle: import_prop_types36.default.number,
    type: import_prop_types36.default.oneOf(["pie"]),
    valueFormatter: import_prop_types36.default.func
  })).isRequired,
  /**
   * If `true`, animations are skiped.
   * @default false
  ...
  tooltip: import_prop_types36.default.shape({
   ...
   * @default null
   */
  topAxis: import_prop_types36.default.oneOfType([import_prop_types36.default.shape({
    axisId: import_prop_types36.default.oneOfType([import_prop_types36.default.number, import_prop_types36.default.string]),
    classes: import_prop_types36.default.object,
    disableLine: import_prop_types36.default.bool,
    disableTicks: import_prop_types36.default.bool,
  ...
  viewBox: import_prop_types36.default.shape({
    height: import_prop_types36.default.number,
    width: import_prop_types36.default.number,
    x: import_prop_types36.default.number,
    y: import_prop_types36.default.number
  }),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   * @default undefined
   ...
   * If not provided, a default axis config is used with id set to `DEFAULT_X_AXIS_KEY`.
   */
  xAxis: import_prop_types36.default.arrayOf(import_prop_types36.default.shape({
    axisId: import_prop_types36.default.oneOfType([import_prop_types36.default.number, import_prop_types36.default.string]),
    classes: import_prop_types36.default.object,
    data: import_prop_types36.default.array,
    dataKey: import_prop_types36.default.string,
    disableLine: import_prop_types36.default.bool,
    disableTicks: import_prop_types36.default.bool,
    fill: import_prop_types36.default.string,
    hideTooltip: import_prop_types36.default.bool,
    id: import_prop_types36.default.oneOfType([import_prop_types36.default.number, import_prop_types36.default.string]),
    label: import_prop_types36.default.string,
    labelFontSize: import_prop_types36.default.number,
    labelStyle: import_prop_types36.default.object,
    max: import_prop_types36.default.oneOfType([import_prop_types36.default.instanceOf(Date), import_prop_types36.default.number]),
    min: import_prop_types36.default.oneOfType([import_prop_types36.default.instanceOf(Date), import_prop_types36.default.number]),
    position: import_prop_types36.default.oneOf(["bottom", "left", "right", "top"]),
    reverse: import_prop_types36.default.bool,
    scaleType: import_prop_types36.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types36.default.object,
    slots: import_prop_types36.default.object,
    stroke: import_prop_types36.default.string,
    tickFontSize: import_prop_types36.default.number,
   ...
   * If not provided, a default axis config is used with id set to `DEFAULT_Y_AXIS_KEY`.
   */
  yAxis: import_prop_types36.default.arrayOf(import_prop_types36.default.shape({
    axisId: import_prop_types36.default.oneOfType([import_prop_types36.default.number, import_prop_types36.default.string]),
    classes: import_prop_types36.default.object,
    data: import_prop_types36.default.array,
    dataKey: import_prop_types36.default.string,
...
function Scatter(props) {
  ...
  const cleanData = React56.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
...
true ? Scatter.propTypes = {
  ...
  markerSize: import_prop_types37.default.number.isRequired,
  series: import_prop_types37.default.shape({
    color: import_prop_types37.default.string.isRequired,
    ...
    type: import_prop_types37.default.oneOf(["scatter"]).isRequired,
    valueFormatter: import_prop_types37.default.func.isRequired,
    xAxisKey: import_prop_types37.default.string,
    yAxisKey: import_prop_types37.default.string
  }).isRequired,
  xScale: import_prop_types37.default.func.isRequired,
  yScale: import_prop_types37.default.func.isRequired
} : void 0;
...
function ScatterPlot(props) {
  ...
  const seriesData = React57.useContext(SeriesContext).scatter;
  const axisData = React57.useContext(CartesianContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
  ...
  return (0, import_jsx_runtime59.jsx)(React57.Fragment, {
    children: seriesOrder.map((seriesId) => {
      const {
        id,
        xAxisKey,
...
var ScatterChart = React58.forwardRef(function ScatterChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
...
true ? ScatterChart.propTypes = {
   ...
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types39.default.oneOfType([import_prop_types39.default.shape({
   ...
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types39.default.oneOfType([import_prop_types39.default.shape({
    axisId: import_prop_types39.default.oneOfType([import_prop_types39.default.number, import_prop_types39.default.string]),
    classes: import_prop_types39.default.object,
    disableLine: import_prop_types39.default.bool,
    disableTicks: import_prop_types39.default.bool,
   ...
   * @default null
   */
  rightAxis: import_prop_types39.default.oneOfType([import_prop_types39.default.shape({
    axisId: import_prop_types39.default.oneOfType([import_prop_types39.default.number, import_prop_types39.default.string]),
    classes: import_prop_types39.default.object,
    disableLine: import_prop_types39.default.bool,
    disableTicks: import_prop_types39.default.bool,
  ...
  series: import_prop_types39.default.arrayOf(import_prop_types39.default.shape({
    ...
    data: import_prop_types39.default.arrayOf(import_prop_types39.default.shape({
      ...
      x: import_prop_types39.default.number.isRequired,
      y: import_prop_types39.default.number.isRequired
    })).isRequired,
    ...
    label: import_prop_types39.default.string,
    markerSize: import_prop_types39.default.number,
    type: import_prop_types39.default.oneOf(["scatter"]),
    valueFormatter: import_prop_types39.default.func,
    xAxisKey: import_prop_types39.default.string,
    yAxisKey: import_prop_types39.default.string
  })).isRequired,
  /**
   * The props used for each component slot.
   * @default {}
   ...
   * @default null
   */
  topAxis: import_prop_types39.default.oneOfType([import_prop_types39.default.shape({
    axisId: import_prop_types39.default.oneOfType([import_prop_types39.default.number, import_prop_types39.default.string]),
    classes: import_prop_types39.default.object,
    disableLine: import_prop_types39.default.bool,
    disableTicks: import_prop_types39.default.bool,
  ...
  xAxis: import_prop_types39.default.arrayOf(import_prop_types39.default.shape({
    ...
    position: import_prop_types39.default.oneOf(["bottom", "left", "right", "top"]),
...
var SparkLineChart = React59.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    width,
    height,
  ...
  return (0, import_jsx_runtime63.jsxs)(ResponsiveChartContainer, {
    ...
    }), plotType === "line" && (0, import_jsx_runtime63.jsxs)(React59.Fragment, {
...
true ? SparkLineChart.propTypes = {
   ...
   * @default false
   */
  area: import_prop_types40.default.bool,
   ...
   * @default 'linear'
   */
  curve: import_prop_types40.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
  /**
   * Data to plot.
   */
  data: import_prop_types40.default.arrayOf(import_prop_types40.default.number).isRequired,
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
   ...
   * @default 'line'
   */
  plotType: import_prop_types40.default.oneOf(["bar", "line"]),
  /**
   ...
   * @default false
   */
  showHighlight: import_prop_types40.default.bool,
  /**
   * Set to `true` to enable the tooltip in the sparkline.
   * @default false
   */
  showTooltip: import_prop_types40.default.bool,
  /**
   ...
   */
  xAxis: import_prop_types40.default.shape({
